...
@property (nonatomic, strong) UIVisualEffect * __nullable effect;
- (void)show;
- (void)hideWithAnimated:(BOOL)anim completion:(void (^ __nullable)(BOOL))completion;
- (void)hideAfterDelay:(NSTimeInterval)delay completion:(void (^ __nullable)(BOOL))completion;
@end
...
+ (UIImage * __nonnull)progressActivityImage;
+ (UIImage * __nonnull)progressCircularImage;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)initWithImage:(UIImage * __nullable)image title:(NSString * __nullable)title subtitle:(NSString * __nullable)subtitle OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithTitle:(NSString * __nullable)title subtitle:(NSString * __nullable)subtitle OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
